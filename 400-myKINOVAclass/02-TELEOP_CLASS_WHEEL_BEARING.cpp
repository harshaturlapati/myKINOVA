...
int main()
{
	int CTRL_MODE = 4; // teleoperation with UDP
	int DURATION = 1000;

	std::string MASTER_IP = "192.180.0.200";
	...
	const std::string master_model = "D:/myKinova_v2/Robot/GEN3_GRIPPER_2024.urdf";
	...
	float k_HIGH_in[7] = { 25.0f, 25.0f, 25.0f, 25.0f, 25.0f, 25.0f, 0.0f };
	float k_LOW_in[7] = { 25.0f, 25.0f, 25.0f, 25.0f, 25.0f, 25.0f, 25.0f };
	float myB = 3;
	//myTELEOP TELEOP(master_PARAMS, slave_PARAMS, 80);

	myTELEOP TELEOP(master_PARAMS, slave_PARAMS, k_LOW_in, k_HIGH_in, myB, my_ext_tau_limit);
